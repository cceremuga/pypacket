...
class TestLogger:
    ...
    def test_log_info_expect_logged(self, capsys):
        ...
        expected_info = Colors.BLUE + Logger.SYS_PREFIX + Colors.RESET + mock_info + self.PRINT_SUFFIX
    ...
    def test_log_error_expect_logged(self, capsys):
        ...
        expected_error = Colors.RED + Logger.ERR_PREFIX + Colors.RESET + mock_error + self.PRINT_SUFFIX
    ...
    def test_log_warn_expect_logged(self, capsys):
        ...
        expected_warn = Colors.YELLOW + Logger.WRN_PREFIX + Colors.RESET + mock_warn + self.PRINT_SUFFIX
    ...
    def test_log_packet_expect_logged(self, capsys):
        ...
        expected_packet = Colors.GREEN + Logger.REC_PREFIX + Colors.RESET + mock_packet + self.PRINT_SUFFIX
